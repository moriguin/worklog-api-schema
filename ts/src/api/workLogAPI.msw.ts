...
export const getWorkLogApiListResponseMock = (overrideResponse: Partial< WorkLogAggregation > = {}): WorkLogAggregation => ({total_h: faker.number.int({min: undefined, max: undefined}), comm_h: faker.number.int({min: undefined, max: undefined}), work_h: faker.number.int({min: undefined, max: undefined}), logs: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({id: faker.string.alpha(20), date: faker.date.past().toISOString().split('T')[0], total_h: faker.number.int({min: undefined, max: undefined}), comm_h: faker.number.int({min: undefined, max: undefined}), work_h: faker.number.int({min: undefined, max: undefined}), memo: faker.helpers.arrayElement([faker.string.alpha(20), undefined])})), ...overrideResponse})

export const getWorkLogApiCreateResponseMock = (overrideResponse: Partial< WorkLog > = {}): WorkLog => ({id: faker.string.alpha(20), date: faker.date.past().toISOString().split('T')[0], total_h: faker.number.int({min: undefined, max: undefined}), comm_h: faker.number.int({min: undefined, max: undefined}), work_h: faker.number.int({min: undefined, max: undefined}), memo: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), ...overrideResponse})

export const getWorkLogApiReadResponseMock = (overrideResponse: Partial< WorkLog > = {}): WorkLog => ({id: faker.string.alpha(20), date: faker.date.past().toISOString().split('T')[0], total_h: faker.number.int({min: undefined, max: undefined}), comm_h: faker.number.int({min: undefined, max: undefined}), work_h: faker.number.int({min: undefined, max: undefined}), memo: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), ...overrideResponse})

export const getWorkLogApiUpdateResponseMock = (overrideResponse: Partial< WorkLog > = {}): WorkLog => ({id: faker.string.alpha(20), date: faker.date.past().toISOString().split('T')[0], total_h: faker.number.int({min: undefined, max: undefined}), comm_h: faker.number.int({min: undefined, max: undefined}), work_h: faker.number.int({min: undefined, max: undefined}), memo: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), ...overrideResponse})
